...
function SignUp({updateLogin, updateUserName}) {
...
function handleSignup(e){
    ...
    const userNameInput = document.forms[0].elements[0].value;
    const userEmail = document.forms[0].elements[1].value;
    const userPassword= document.forms[0].elements[2].value;
    const userPasswordConfirm = document.forms[0].elements[3].value;
    ...
    if(userPassword ===userPasswordConfirm){
        ...
        // console.log(user);
        alert("Congratulations, You are now a member of Linkedin Community. Login now!");
        setSignup(true);
    ...
    // console.log(userNameInput,userEmail,userPassword,userPasswordConfirm);
    ...
    return (
         ...
         signup?(<Login toggleSignup={toggleSignup} updateLogin={updateLogin} />) :(
            <>
            ...
            <form onSubmit={handleSignup}>
                ...
                <input type="text" name="" id="userPasswordConfirm" placeholder='Confirm password' required />
                <br />
                ...
                <div className='sign_in'>
                    <h4>Already a User? <span onClick={toggleSignup} >Sign in</span></h4>
                </div>
